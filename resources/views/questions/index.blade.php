        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">AllQuestions
                    ...
                    @foreach ($questions as $question)
                        <div class="card-body">
                            <div class="media">
                                <div class="flex flex-column statistics">
                                    <div class="votes text-center mb-3">
                                        <strong class="d-block">{{$question->votes_count}}</strong>
                                        Votes
                                    </div>
                                    <div class="answers text-center mb-3">
                                        <strong class="d-block answers {{ $question->answers_style_ }}">{{$question->answers_count}}</strong>
                                        Answers
                                    </div>
